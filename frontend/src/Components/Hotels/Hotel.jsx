          ...
          <div className="flex justify-between">
            <div>
              ...
              <p className="text-green-600 mt-2 font-semibold">
                Book a stay over MAD {data.cheapestPrice} at this property and
          ...
          <div className="mt-8 grid grid-cols-3 gap-10 text-gray-800 mb-8">
            <div className="col-span-2">
              ...
              <p className="text-lg text-gray-500">
                ...
                At, pariatur tempora, voluptatibus quasi delectus culpa beatae
                animi ipsum quibusdam quis eligendi eum praesentium? Illo
                deleniti commodi culpa sunt suscipit ut alias fugit ipsum!
                praesentium? Illo deleniti commodi culpa sunt suscipit ut alias
                fugit ipsum!praesentium? Illo deleniti commodi culpa sunt
                suscipit ut alias fugit ipsum!
              </p>
            </div>
